...
/*   Updated: 2023/10/28 16:08:01 by rbattal          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/cub3d.h"
/*
int tx, ty = x ve y koordinatındaki pixel texturesi
ty_step = y koordinatındaki adım miktarını belirler. 
	Bu, duvarın yüksekliğine bağlı olarak hesaplanır.
ty_off değişkeni, yüksek duvarların görüntülenmesi durumunda 
	y koordinatındaki bir ofseti temsil eder. 
	Eğer duvarın yüksekliği ekrandan yüksekse bu ofset hesaplanır

image.get_addr[(abs(ty) * image.width) + abs(tx)] ifadesi, 
	belirli bir koordinattaki piksel rengini alır. 
	tx, ty texel indeksleri kullanılarak uygun texeldeki piksel rengi alınır

temelde duvar perspektifi ve duvarlara basılacak 
	piksel rengi için kullanılır(son satır, abs() fonksiyonu mutlak değer alır)
*/
