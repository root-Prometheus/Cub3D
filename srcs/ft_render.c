...
/*   Updated: 2023/10/31 13:48:16 by rbattal          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
if coordinates[1] < HEIGHT / 2 we put the color of the ceiling
else we put the floor's color
*/
...
/*
firstly draw the window's background as a floor or ceiling
then we start to calculate walls from the right side to left
meanwhile we check if not invalid ll_render or we are not in a wall (49 it's the ascii code of 1)
